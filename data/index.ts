...
export const projects = [
  {
    ...
    link: "https://shoe-store-frontend.vercel.app/",
  },
  {
    id: 2,
    title: "3D Infinite",
...
export const workExperience = [
  {
    ...
    desc: "Developed and maintained robust web applications using JavaScript, HTML5, CSS3, and PHP (Laravel).",
  ...
  },
  {
    ...
    desc: "Spearheaded scalable web applications using React, Angular, and Vue.js for dynamic user experiences.",
  ...
  },
  {
    ...
    desc: "Redesigned the customer portal, increasing user engagement by 30% and improving retention.",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "/exp3.svg",
  },
  {
    ...
    desc: "Developed a scalable, secure payment system, boosting user transactions by 25%.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
] as const;
